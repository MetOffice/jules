...
USE jules_irrig_mod, ONLY: l_soil_evap_irrig_separate
...
!$OMP        gc_irr_surft,gc_nir_surft,l_soil_evap_irrig_separate,flake,       &
...
!$OMP                 gc_irr_surft, l_soil_evap_irrig_separate)                &
!$OMP                 SCHEDULE(STATIC)
    DO k = 1,surft_pts
      l = surft_index(k)
