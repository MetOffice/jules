...
.. nml:member:: l_moruses_albedo
   ...
   MORUSES switch for effective canyon albedo parametrisation (snow free).
   ...
   TRUE
       Use MORUSES parametrisation. Requires that :nml:mem:`JULES_RADIATION::l_cosz` = TRUE. Also, check whether the data are provided in UTC or local solar time. To assume local solar time set :nml:mem:`JULES_TIME::l_local_solar_time` = TRUE.
...
.. nml:member:: l_moruses_emissivity
   ...
   MORUSES switch for effective canyon emissivity parametrisation.
...
.. nml:member:: l_moruses_rough
   ...
   MORUSES switch for effective roughness length for heat parametrisation.
   ...
   TRUE
       Use MORUSES parametrisation for canyon and roof.
...
.. nml:member:: l_moruses_storage
   ...
   **The roof**:
   ...
   TRUE
       Use MORUSES parametrisation as described above.
