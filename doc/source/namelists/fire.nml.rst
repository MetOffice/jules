...
.. nml:member:: flam_rhum_low
   ...
   Lower relative humidity threshold for relationship between relative humidity and flammability below which value of flammability is 1.0. Expressed as a percentage.
...
.. nml:member:: flam_rhum_up
   ...
   Upper relative humidity threshold for relationship between relative humidity and flammability above which value of flammability is 0.0. Expressed as a percentage.
...
.. nml:member:: flam_rain_const
   ...
   An exponential decay factor that defines the relationship between flammability and rainfall. In order to recreate the relationship hardwired into JULES version 8.2 and lower this value should be set to 14929920000.0. However, this is not the relationship that was documented by Mangeon et al. (2016). If you want the Mangeon et al. relationship then this value should be 172800.0. If you want to remove the dependence of flammability on rainfall then this value should be set to 0.0.
...
.. nml:member:: flam_fuel_up
   ...
   Upper fuel load threshold for flammability
