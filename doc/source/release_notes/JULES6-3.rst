 ...
 *  Restructured the parametrisation of thermal acclimation of photosynthesis to permit a wider range of configurations - see :nml:mem:`JULES_VEGETATION::photo_acclim_model`. (#1142)
